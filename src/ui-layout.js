...
angular.module('ui.layout', [])
  .controller('uiLayoutCtrl', ['$scope', '$attrs', '$element', '$timeout', '$window', 'LayoutContainer', 'Layout', function uiLayoutCtrl
    ($scope, $attrs, $element, $timeout, $window, LayoutContainer, Layout) {
    ...
    function draw() {
      var position = ctrl.sizeProperties.flowProperty; // left/top
    ...
    ctrl.processSplitbar = function(container) {
      ...
      var setValues = function(container) {
        var start = container[ctrl.sizeProperties.flowProperty]; // top or left
